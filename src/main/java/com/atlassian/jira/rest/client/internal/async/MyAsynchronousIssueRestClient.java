...
public class MyAsynchronousIssueRestClient extends AbstractAsynchronousRestClient implements IssueRestClient {
    ...
    private final MyIssueJsonParser issueParser = new MyIssueJsonParser();
    ...
    public MyAsynchronousIssueRestClient(final URI baseUri, final HttpClient client, final SessionRestClient sessionRestClient,
