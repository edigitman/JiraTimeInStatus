...
public class MyAsynchronousJiraRestClient implements JiraRestClient {
    ...
    public MyAsynchronousJiraRestClient(final URI serverUri, final DisposableHttpClient httpClient) {
        ...
        issueRestClient = new MyAsynchronousIssueRestClient(baseUri, httpClient, sessionRestClient, metadataRestClient);
